...
namespace OverLoad_Client
{
    internal class DataBaseFunctions
    {
        ...
        public  double Account_GetAmountMoney(uint boxid, uint currencyid)
        {
            ...
            {
                MessageBox.Show("Account_GetAmountMoney"+ee.Message ,"",MessageBoxButtons.OK,MessageBoxIcon.Error );
                return -1;
            }
        }
        internal string Account_GetAmountMoneyOverAll(MoneyBox moneybox)
        {
            ...
            {
                MessageBox.Show("Account_GetAmountMoneyOverAll:" + ee.Message ,"",MessageBoxButtons.OK,MessageBoxIcon.Error );
                return "";
            }
        }
        ...
        //    catch (Exception ee)
        //    {
        //        MessageBox.Show("ConvertPayINList_TO_String:" + ee.Message, "", MessageBoxButtons.OK, MessageBoxIcon.Error);
        //        return "";
        //    }
        //}
        ...
        //    catch (Exception ee)
        //    {
        //        MessageBox.Show("ConvertPayOutList_TO_String:" + ee.Message, "", MessageBoxButtons.OK, MessageBoxIcon.Error);
        //        return "";
        //    }
        //}
        internal string Account_GetMoneyIN_As_String(List<PayCurrencyReport> PayCurrencyReportList)
        {
            ...
            {
                MessageBox.Show("Account_GetMoneyIN_As_String:" + ee.Message, "", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            return return_str;
        }
        internal string Account_GetMoneyOUT_As_String(List<PayCurrencyReport> PayCurrencyReportList)
        {
            ...
            {
                MessageBox.Show("Account_GetMoneyOUT_As_String:" + ee.Message , "",MessageBoxButtons.OK ,MessageBoxIcon.Error );
            }
            return return_str;
        }
      ...
      //                  new PayCurrencyReport(currency, payin_sell, payin_mainenance,payin_moneytransform, payin_non
      ...
      //      catch (Exception ee)
      //      {
      //          MessageBox.Show("Account_GetPays_DayReport:" + ee.Message, "", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return PayCurrencyReportList;
      //      }
      //  }
      ...
      //      catch (Exception ee)
      //      {
      //          MessageBox.Show("Account_GetPays_MonthReport:" + ee.Message, "", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return PayCurrencyReportList;
      //      }
      //  }
      ...
      //      catch (Exception ee)
      //      {
      //          MessageBox.Show("Account_GetPays_YearReport:" + ee.Message, "", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return PayCurrencyReportList;
      //      }
      //  }
      ...
      //      catch (Exception ee)
      //      {
      //          MessageBox.Show("Account_GetPays_YearRangeReport:" + ee.Message, "", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return PayCurrencyReportList;
      //      }
      //  }
      ...
      //              if (day_payout_list[i]._Bill == null) owner = "";
      //              else if (day_payout_list[i]._Bill._Operation.OperationType ==Operation.BILL_BUY) owner = " فاتورة شراء رقم:"+ day_payout_list[i]._Bill._Operation.OperationID;
      //              else if (day_payout_list[i]._Bill._Operation.OperationType == Operation.Employee_PayOrder) owner = " امر صرف رقم:"+ day_payout_list[i]._Bill._Operation.OperationID;
      //              else owner = "";
      ...
      //              string currency= day_payout_list[i]._Currency .CurrencyName;
      ...
      //              double realvalue = value / exchangerate;
      //              string currency = day_payin_list[i]._Currency.CurrencyName;
      //              AccountOprReportDetail accountopr_reportDetail
      //                  = new AccountOprReportDetail(accountoprdate, accountoprtype, Direction_, accountopr_id, owner
      //                  , value, currency, exchangerate, realvalue);
      //              AccountOprReportDetailList.Add(accountopr_reportDetail);
      ...
      //              double realvalue = value / exchangerate;
      //              string currency = MoneyBox_IN_moneytransform_list[i]._Currency.CurrencyName;
      //              AccountOprReportDetail accountopr_reportDetail
      //                  = new AccountOprReportDetail(accountoprdate, accountoprtype, Direction_, accountopr_id, owner
      //                  , value, currency, exchangerate, realvalue);
      //              AccountOprReportDetailList.Add(accountopr_reportDetail);
      ...
      //              double realvalue = value / exchangerate;
      //              string currency = MoneyBox_OUT_moneytransform_list[i]._Currency.CurrencyName;
      //              AccountOprReportDetail accountopr_reportDetail
      //                  = new AccountOprReportDetail(accountoprdate, accountoprtype, Direction_, accountopr_id, owner
      //                  , value, currency, exchangerate, realvalue);
      //              AccountOprReportDetailList.Add(accountopr_reportDetail);
      ...
      //              string in_currency = day_exchangeopr_list[i].TargetCurrency.CurrencyName;
      //              string out_currency = day_exchangeopr_list[i].SourceCurrency.CurrencyName;
      ...
      //                   , invalue , in_currency, in_exchangerate, in_realvalue);
      ...
      //                   , outvalue, out_currency, out_exchangerate, out_realvalue);
      ...
      //      catch (Exception ee)
      //      {
      //          MessageBox.Show("GetAccountOprReport_Details_InDay:" + ee.Message, "", MessageBoxButtons.OK, MessageBoxIcon.Error);
      ...
      //              List<Money_Currency> All_Money_IN_List = new List<AccountingObj.Objects.Money_Currency>();
      //              List<Money_Currency> All_Money_OUT_List = new List<AccountingObj.Objects.Money_Currency>();
      ...
      //      catch (Exception ee)
      //      {
      //          MessageBox.Show("GetAccountOprReport_Details_InMonh:" + ee.Message, "", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return AccountOprReportDetailList;
      //      }
      //  }
      ...
      //      catch (Exception ee)
      //      {
      //          MessageBox.Show("GetAccountOprReport_Details_InYear:" + ee.Message, "", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return AccountOprReportDetailList;
      //      }
      //  }
      ...
      //      catch (Exception ee)
      //      {
      //          MessageBox.Show("GetAccountOprReport_Details_InYearRange:" + ee.Message, "", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return AccountOprReportDetailList;
      //      }
      //  }
      //  #endregion
      ...
      //                  clause_Count, amountin, amountremain, billvalue, currency, exchangerate
      ...
      //      catch(Exception ee)
      //      {
      //          MessageBox.Show("Get_Report_Buys_Day_ReportDetail:"+ee.Message , "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return List;
      //      }
      //  }
      ...
      //      catch(Exception ee)
      //      {
      //          MessageBox.Show("Get_Report_Buys_Month_ReportDetail:"+ee.Message , "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return List;
      //      }
      //  }
      ...
      //      catch(Exception ee)
      //      {
      //          MessageBox.Show("Get_Report_Buys_Year_ReportDetail:"+ee.Message , "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return List;
      //      }
      //  }
      ...
      //      catch(Exception ee)
      //      {
      //          MessageBox.Show("Get_Report_Buys_YearRange_ReportDetail:"+ee.Message , "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return List;
      //      }
      //  }
      ...
      //      try
      //      {
      //          List<Report_Buys_Month_ReportDetail> list = Get_Report_Buys_Month_ReportDetail(year, month).Where (x=>x.DayID ==day ).ToList ();

      //          return list[0];
      //      }
      //      catch(Exception ee)
      //      {
      //          MessageBox.Show("Get_Report_Buys_Day_Report:"+ee.Message , "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return null;
      //      }
      //  }
      ...
      //      try
      //      {
      //          List<Report_Buys_Year_ReportDetail> list = Get_Report_Buys_Year_ReportDetail(year).Where(x => x.MonthNO == month ).ToList();

      //          return list[0];
      //      }
      //      catch (Exception ee)
      //      {
      //          MessageBox.Show("Get_Report_Buys_Month_Report:" + ee.Message, "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return null;
      //      }
      //  }
      ...
      //      try
      //      {
      //          List<Report_Buys_YearRange_ReportDetail> list = Get_Report_Buys_YearRange_ReportDetail(year,year).Where(x => x.YearNO == year ).ToList();

      //          return list[0];
      //      }
      //      catch (Exception ee)
      //      {
      //          MessageBox.Show("Get_Report_Buys_Year_Report:" + ee.Message, "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return null;
      //      }
      //  }
      //  #endregion
      ...
      //              double paysremain = new OperationSQL(DB).Get_OperationPaysValue_UPON_OperationCurrency(new Operation(Operation.Employee_PayOrder, EmployeePayOrderList[i].PayOrderID));
      ...
      //      catch(Exception ee)
      //      {
      //          MessageBox.Show("Get_Report_PayOrders_Day_ReportDetail:"+ee.Message , "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return List;
      //      }
      //  }
      ...
      //              List<Money_Currency> Money_Currency_PayOrders_Value = Money_Currency.Get_Money_Currency_List_From_EmployeePayOrder(EmployeePayOrderList);
      //              List<Money_Currency> Money_Currency_Paysvalues = new List<Money_Currency>();
      //              List<Money_Currency> Money_Currency_Paysremain = new List<Money_Currency>();
      ...
      //      catch(Exception ee)
      //      {
      //          MessageBox.Show("Get_Report_PayOrders_Month_ReportDetail:"+ee.Message , "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return List;
      //      }
      //  }
      ...
      //      catch(Exception ee)
      //      {
      //          MessageBox.Show("Get_Report_PayOrders_Year_ReportDetail:"+ee.Message , "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return List;
      //      }
      //  }
      ...
      //      catch (Exception ee)
      //      {
      //          MessageBox.Show(" Get_Report_PayOrders_YearRange_ReportDetail: " + ee.Message, "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return List;
      //      }
      //  }
      ...
      //      try
      //      {
      //          List<Report_PayOrders_Month_ReportDetail> list = Get_Report_PayOrders_Month_ReportDetail(year, month).Where(x => x.DayID == day).ToList();

      //          return list[0];
      //      }
      //      catch (Exception ee)
      //      {
      //          MessageBox.Show("Get_Report_PayOrders_Day_Report:" + ee.Message, "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return null;
      //      }
      //  }
      ...
      //      try
      //      {
      //          List<Report_PayOrders_Year_ReportDetail> list = Get_Report_PayOrders_Year_ReportDetail(year).Where(x => x.MonthNO == month).ToList();

      //          return list[0];
      //      }
      //      catch (Exception ee)
      //      {
      //          MessageBox.Show("Get_Report_PayOrders_Month_Report:" + ee.Message, "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return null;
      //      }
      //  }
      ...
      //      try
      //      {
      //          List<Report_PayOrders_YearRange_ReportDetail> list = Get_Report_PayOrders_YearRange_ReportDetail(year, year).Where(x => x.YearNO == year).ToList();

      //          return list[0];
      //      }
      //      catch (Exception ee)
      //      {
      //          MessageBox.Show("Get_Report_PayOrders_Year_Report:" + ee.Message, "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return null;
      //      }
      //  }
      //  #endregion
      ...
      //              double itemsout_realvalue = System.Math.Round(itemoutlist.Sum(x => x._OUTValue.Value / x._OUTValue.ExchangeRate),3);
      ...
      //                  clause_Count, billvalue, currency, exchangerate, PaysCount, PaysAmount, remain
      ...
      //      catch(Exception ee)
      //      {
      //          MessageBox.Show("Get_Report_Sells_Day_ReportDetail:"+ee.Message , "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return List;
      //      }
      //  }
      ...
      //      catch(Exception ee)
      //      {
      //          MessageBox.Show("Get_Report_Sells_Month_ReportDetail:" + ee.Message , "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      ...
      //      try
      //      {
      //          List<Report_Sells_Month_ReportDetail> list = Get_Report_Sells_Month_ReportDetail(year, month).Where(x => x.DayID == day).ToList();
       
      //          return list[0];
      //      }
      //      catch (Exception ee)
      //      {
      //          MessageBox.Show("Get_Report_Sells_Day_Report:" + ee.Message, "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return null;
      //      }
      //  }
      ...
      //      try
      //      {
      //          List<Report_Sells_Year_ReportDetail> list = Get_Report_Sells_Year_ReportDetail(year).Where(x => x.MonthNO == month).ToList();

      //          return list[0];
      //      }
      //      catch (Exception ee)
      //      {
      //          MessageBox.Show("Get_Report_Sells_Month_Report:" + ee.Message, "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return null;
      //      }
      //  }
      ...
      //      try
      //      {
      //          List<Report_Sells_YearRange_ReportDetail> list = Get_Report_Sells_YearRange_ReportDetail(year, year).Where(x => x.YearNO == year).ToList();

      //          return list[0];
      //      }
      //      catch (Exception ee)
      //      {
      //          MessageBox.Show("Get_Report_Sells_Year_Report:" + ee.Message, "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return null;
      //      }
      //  }
      //  #endregion 
      ...
      //          List<MaintenanceOPR> AllMaintenanceOPRList = new Maintenance.MaintenanceSQL.MaintenanceOPRSQL(DB).GetAllMaintenanceOPRs();
      ...
      //                  currency = BillMaintenance_._Currency ;
      ...
      //                  List<Money_Currency> itemoutlist_Money_Currency = new ItemOUTSQL(DB).GetItemOUTList_AS_Money_Currency(BillMaintenance_._Operation);
      ...
      //              double bills_itemsout_realvalue = itemsoutlist_money_currency.Sum(x => x.Value / x.ExchangeRate);

      //              double bills_realvalue = billsvalue_money_Currency .Sum (x=>x.Value /x.ExchangeRate );
      //              double bills_pays_realvalue = paysamount_money_Currency.Sum(x => x.Value / x.ExchangeRate);
      ...
      //      try
      //      {
      //          List<Report_MaintenanceOPRs_Month_ReportDetail> list = Get_Report_MaintenanceOPRs_Month_ReportDetail(year, month).Where(x => x.DayID == day).ToList();
      ...
      //      try
      //      {
      //          List<Report_MaintenanceOPRs_Year_ReportDetail> list = Get_Report_MaintenanceOPRs_Year_ReportDetail(year).Where(x => x.MonthNO == month).ToList();
      ...
      //      try
      //      {
      //          List<Report_MaintenanceOPRs_YearRange_ReportDetail> list = Get_Report_MaintenanceOPRs_YearRange_ReportDetail(year, year).Where(x => x.YearNO == year).ToList();
      ...
      //          //    List<MaintenanceOPR> Contact_MaintenanceOPRList = new Maintenance.MaintenanceSQL.MaintenanceOPRSQL(DB).GetAllMaintenanceOPRs().Where(x => x._Contact.ContactID == ContactID).ToList();
      //          //    List<BillMaintenance> Contact_BillMaintenaceList = new List<BillMaintenance>();
      //          //    List<PayIN> Contact_payin_list = new List<AccountingObj.Objects.PayIN>();
      //          //    List<PayOUT> Contact_payout_list = new List<AccountingObj.Objects.PayOUT >();
      ...
      //          //            = new Contact_Pays_ReportDetail(Bill_ , Contact_Pays_ReportDetail.DIRECTION_OUT
      //          //            , PayOprDate,PayOprID,value , currency, exchangerate, realvalue);
      ...
      //          //        Contact_Pays_ReportDetail Contact_Pays_ReportDetail_
      //          //            = new Contact_Pays_ReportDetail(Bill_, Contact_Pays_ReportDetail.DIRECTION_IN
      //          //            , PayOprDate, PayOprID, value, currency, exchangerate, realvalue);
      //          //        Contact_Pays_ReportDetailList.Add(Contact_Pays_ReportDetail_);
      //          //    }
      ...
      //      catch(Exception ee)
      //      {
      //          MessageBox.Show("Contact_Get_Pays_ReportDetail:"+ee.Message , "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return Contact_Pays_ReportDetailList;
      //      }
      //  }
      ...
      //          //        paysremain = new OperationSQL(DB).Get_OperationPaysValue_UPON_OperationCurrency(BillMaintenance_._Operation);
      ...
      //          //    double billvalue = itemoutlist.Sum(x => x._OUTValue.Value) + additionalclausesList.Sum(x => x.Value) ;
      ...
      //          //    List<ItemIN> sourceitemin = itemoutlist.Select(x => x._ItemIN).ToList();
      //          //    List<Money_Currency> itemin_MOney_Currency = Money_Currency.Get_Money_Currency_List_From_ItemIN(sourceitemin);
      //          //    string bill_source_itemsin_cost = Money_Currency.ConvertMoney_CurrencyList_TOString(itemin_MOney_Currency);
      //          //    double bill_source_itemsin_realcost = itemin_MOney_Currency.Sum(x => x.Value / x.ExchangeRate);
      //          //    double itemsout_realvalue = itemoutlist.Sum(x => x._OUTValue.Value / x._OUTValue.ExchangeRate);
      ...
      //                  clause_Count, amountin , amountremain, billvalue, currency.CurrencyID ,currency.CurrencyName,currency.CurrencySymbol
      //                  , exchangerate
      //                  , PaysAmount, paysremain, billrealvalue, bill_Pays_realvalue, itemsoutvalue, itemsoutRealvalue
      //                  , bill_pays_returns_value, bill_pays_returns_realvalue);
      ...
      //              source_itemsin_list_Money_Currency.AddRange(Money_Currency .Get_Money_Currency_List_From_ItemIN( itemoutlist.Select(x => x._ItemIN).ToList()));
      ...
      //                  itemoutlist_Money_Currency.AddRange(new ItemOUTSQL(DB).GetItemOUTList_AS_Money_Currency(BillMaintenance_._Operation));
      ...
      //      catch (Exception ee)
      //      {
      //          MessageBox.Show("Contact_Get_Report_Maintenance: " + ee.Message, "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
      //          return null ;
      //      }
      ...
      //          //List<Currency> currencylist = Contact_Pays_ReportDetail_List.Select(x => x._Currency).ToList();
      //          //List<uint > currencyIDList = currencylist.Select(x => x.CurrencyID).Distinct().ToList();
      //          //for (int i = 0; i < currencyIDList.Count ; i++)
      //          //{
      //          //    uint currencyid = currencyIDList[i];
      //          //    Currency Currency_ = currencylist.Where(x => x.CurrencyID == currencyIDList[i]).ToList()[0] ;
      //          //    double payin_sell = Contact_Pays_ReportDetail_List.Where (y=>y._Bill._Operation.OperationType 
      //          //    ==Operation.BILL_SELL).Sum (x=>x.Value );
      //          //    double payin_mainenance = Contact_Pays_ReportDetail_List.Where(y => y._Bill._Operation.OperationType
      //          //   == Operation.BILL_MAINTENANCE ).Sum(x => x.Value);

      //          //    double payout_buy = Contact_Pays_ReportDetail_List.Where(y => y._Bill._Operation.OperationType
      ...
      //  #endregion
        ...
        public List<EmployeeMent_Employee_Report> Company_Get_EmployeeMent_Employee_Report_List()
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("Get_EmployeeMent_Employee_Report_List" + ee.Message, "", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
                return list ;
            }
        }
        public List<EmployeesReport> Company_GetEmployeesReportList()
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("Company_GetEmployeesReportList" + ee.Message, "", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
                return null;
            }
        }
        #endregion
